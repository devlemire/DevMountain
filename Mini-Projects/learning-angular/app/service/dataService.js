angular
  ...
  for(var i = 0; i < teamAvengers.length; i++) {
    arr.push({
      name: teamAvengers[i].name,
      description: teamAvengers[i].description,
      thumbnail: {
        path: teamAvengers[i].thumbnail.path,
        extension: teamAvengers[i].thumbnail.extension
      }
    });
  }
