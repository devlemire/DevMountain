...
test('Change a users language', async t => {
  ...
  t.is(req.status, 200);
  console.log("Test log 1 : ", req.body);
  console.log("Test log 2 : " , req.body.language);
  t.truthy(req.body.language, "No language returned " + req.body);
  ...
  t.is(req.status, 200);
  t.truthy(req.body.language, "No language returned 2" + req.body);
