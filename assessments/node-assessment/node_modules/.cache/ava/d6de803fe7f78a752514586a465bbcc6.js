        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 14:
            ...
            t.truthy(_rec21._expr(_rec21._capt(_rec21._capt(_rec21._capt(req, 'arguments/0/object/object').body, 'arguments/0/object').language, 'arguments/0'), {
              content: 't.truthy(req.body.language, "No language returned " + req.body)',
              filepath: 'test.js',
              line: 102,
              async: true
            }), "No language returned " + req.body);
          ...
          case 26:
            ...
            t.truthy(_rec25._expr(_rec25._capt(_rec25._capt(_rec25._capt(req, 'arguments/0/object/object').body, 'arguments/0/object').language, 'arguments/0'), {
              content: 't.truthy(req.body.language, "No language returned 2" + req.body)',
              filepath: 'test.js',
              line: 115,
              async: true
            }), "No language returned 2" + req.body);
...
//# sourceMappingURL=node_modules/.cache/ava/d6de803fe7f78a752514586a465bbcc6.js.map